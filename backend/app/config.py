...
DEMO_OTP_IN_RESPONSE = _bool_env("SECUREDOC_DEMO_OTP_IN_RESPONSE", False) and not IS_PRODUCTION
SYNC_SEEDED_USERS = _bool_env("SECUREDOC_SYNC_SEEDED_USERS", False) and not IS_PRODUCTION
